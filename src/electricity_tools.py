...
def register_electricity_tools(mcp_server):
    ...
    def get_monitored_buildings() -> str:
    ...
    def get_building_data_range(building: str) -> str:
        """
    ...
    def get_energy_usages(start_date_time: str, end_date_time: str, building: str) -> str:
        """
    ...
    def get_total_energy_usage(start_date_time: str, end_date_time: str, building: str) -> str:
        ...
        try:
            ...
            result = service_get_total_energy_usage(start_date_time, end_date_time, building)
